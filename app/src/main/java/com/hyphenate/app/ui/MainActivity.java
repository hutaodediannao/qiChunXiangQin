...
import com.hyphenate.app.Constant;
import com.hyphenate.app.DemoHelper;
import com.hyphenate.app.HMSPushHelper;
import com.hyphenate.app.R;
import com.hyphenate.app.db.InviteMessgeDao;
import com.hyphenate.app.db.UserDao;
import com.hyphenate.app.runtimepermissions.PermissionsManager;
import com.hyphenate.app.runtimepermissions.PermissionsResultAction;
import com.hyphenate.app.ui.ext.CircleFragment;
import com.hyphenate.app.ui.ext.MeetFragment;
...
public class MainActivity extends BaseActivity {
    ...
    private BaseFragment meetFragment, circleFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        meetFragment = BaseFragment.newInstance(MeetFragment.class);
        circleFragment = BaseFragment.newInstance(CircleFragment.class);
        fragments = new Fragment[]{meetFragment, circleFragment, conversationListFragment, contactListFragment, settingFragment};

        getSupportFragmentManager().beginTransaction()
                .add(R.id.fragment_container, meetFragment)
...
//				Toast.makeText(MainActivity.this, "All permissions have been granted", Toast.LENGTH_SHORT).show();
    ...
    private void initView() {
        ...
        mTabs = new Button[5];
        mTabs[0] = findViewById(R.id.btn_meet);
        mTabs[1] = findViewById(R.id.btn_circle);
        mTabs[2] = findViewById(R.id.btn_conversation);
        mTabs[3] = findViewById(R.id.btn_address_list);
